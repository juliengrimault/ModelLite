...
@interface JGRDbMapping()
@property (nonatomic, strong) Class<JGRDbObject> modelClass;
@property (nonatomic, copy) NSString *tableName;
@property (nonatomic, copy) NSDictionary *properties;
@end

@implementation JGRDbMapping

- (id)initWithClass:(Class<JGRDbObject>)modelClass
...
- (NSString *)description
{
    ...
    for (NSString *propertyName in self.properties) {
        ...
        [propertiesDescriptions addObject:[NSString stringWithFormat:@"%@ -> %@", propertyName, JGRDbNSStringFromDbPropertyType(propertyType)]];
    }
...
- (BOOL)isEqual:(id)object
{
    ...
    return [self isEqualToDbMapping:(JGRDbMapping *)object];
}

- (BOOL)isEqualToDbMapping:(JGRDbMapping *)mapping
{
